...
exports.book_delete_get = asyncHandler(async (req, res, next) => {
  ...
  // Find all instances of the book
  const bookInstances = await BookInstance.find({ book: book._id }).exec();
...
exports.book_delete_post = asyncHandler(async (req, res, next) => {
  // Get the book and its book instances
  const [book, bookInstances] = await Promise.all([
  ...
  if (bookInstances.length > 0) {
    ...
    // Book has no instances, delete the book and redirect to the book list
